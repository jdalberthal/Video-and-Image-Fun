...
# --- Script Metadata ---
$ExternalButtonName = "3D Curved Vortex`n(FFmpeg)"
$ScriptDescription = "Displays media on curved panels that spiral down a stationary 3D vortex. Uses FFmpeg for broad video format support."
...
while ($true) {
    ...
    $SelectForm.Text = "3D Curved Vortex (FFmpeg) - Media Selector"
